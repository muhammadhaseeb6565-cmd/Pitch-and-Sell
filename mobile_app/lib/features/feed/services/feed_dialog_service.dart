...
class FeedDialogService {
  static void showOrderCheckoutSheet(
    ...
    final colors =
        rawColors.isNotEmpty ? rawColors.cast<String>() : ['Default'];
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setModalState) {
            final price =
                double.tryParse(productData['price'].toString()) ?? 1200.0;
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          child:
                              const Icon(Icons.store, color: Color(0xffFF5722)),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(productData['business']['name'],
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13)),
                              const Text(
                                  'Verified Business Seller · KYC Verified',
                                  style: TextStyle(
                            ...
                            child: OutlinedButton(
                              ...
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                        'Added $qty ${productData['name']} to Cart!'),
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              final res =
                                  await ApiService.addComment(videoId, txt);
